...
else return m.reply(`⚡ La url es incorrecto`)
...
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: packname, body: `⚡ ̸̷᮫໊᷐͢᷍ᰍ ELISABET 2.0`, mediaType: 2, sourceUrl: redes, thumbnail: icons}}}, { quoted: m })
